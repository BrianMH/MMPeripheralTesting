...
// Defines
#define _CLOCKS_INIT    RCC_AHB1Periph_GPIOB | RCC_AHB1Periph_GPIOA | RCC_AHB1Periph_GPIOC

#define _CLOCK_PIN 		GPIO_Pin_5    	// PA5
#define _CLOCK_GROUP    GPIOA
#define _CLOCK_SOURCE   GPIO_PinSource5

#define _DATAIN_PIN 	   GPIO_Pin_4		// PB4
#define _DATAIN_GROUP   GPIOB
#define _DATAIN_SOURCE  GPIO_PinSource4

#define _DATAOUT_PIN 	GPIO_Pin_5		// PB5
#define _DATAOUT_GROUP  GPIOB
#define _DATAOUT_SOURCE GPIO_PinSource5

#define _FSYNC_PIN      GPIO_Pin_7     // PB7
#define _FSYNC_GROUP    GPIOB

#define _CS_PIN 		   GPIO_Pin_12		// PC12
#define _CS_GROUP       GPIOC

#define _SPI_CHANNEL    SPI2
#define _SPI_ALT_DERIV  GPIO_AF_SPI1   // define this as similar to above
#define _SPI_RCC_CLOCK  RCC_APB2Periph_SPI1  // likewise
