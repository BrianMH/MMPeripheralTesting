...
uint16_t REC_readValue(ADC_TypeDef* ADCx, uint8_t ADC_channel) {
  // set pin to read
  ADC_RegularChannelConfig(ADCx, ADC_channel, 1, ADC_SampleTime_28Cycles);
...
#define READ_LEFT_REC      REC_readValue(ADC1, ADC_Channel_13)
#define READ_BLEFT_REC     REC_readValue(ADC1, ADC_Channel_12)
#define READ_FLEFT_REC     REC_readValue(ADC1, ADC_Channel_11)
#define READ_FRONT_REC     REC_readValue(ADC1, ADC_Channel_10)
#define READ_FRIGHT_REC    REC_readValue(ADC1, ADC_Channel_14)
#define READ_BRIGHT_REC    REC_readValue(ADC1, ADC_Channel_8)
#define READ_RIGHT_REC     REC_readValue(ADC1, ADC_Channel_9)
/**************************************************************/
#ifdef __cplusplus
  }
#endif
